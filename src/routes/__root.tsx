...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Grip — Physical Climate Risk Intelligence" },
      { name: "description", content: "Score your asset portfolio against physical climate hazards using open IPCC AR6-aligned datasets and a 5-agent intelligence system." },
    ],
